...
class SemanticEmbedder:
    ...
    def extract_text_for_embedding(self, knowledge: Dict) -> str:
        ...
        # 提取列表中的关键内容
        for list_key in ["elements", "rules", "concepts", "principles", 
                         "scenarios", "validation_rules"]:
...
class SemanticDeduplicator:
    ...
    def check_semantic_duplicate(self, new_item: Dict, existing_items: List[Dict]) -> Tuple[bool, Optional[int], float]:
        """
        检查新知识是否与已有知识语义重复
