...
class LLMMerger:
    ...
    def __init__(self, model_id: str = None):
        ...
        """
        # 优先使用 KB_MODEL_ID（统一模型），否则使用 KB_MODEL_DEFAULT
        self.model_id = model_id or os.getenv("KB_MODEL_ID") or os.getenv("KB_MODEL_DEFAULT", "Qwen/Qwen3-8B")
        ...
        if not self.api_key:
            print("[LLMMerger] 警告: OPENAI_API_KEY 未设置")
