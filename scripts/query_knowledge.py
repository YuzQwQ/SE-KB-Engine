...
def run_query(retriever: KnowledgeRetriever, query: str, intent_type: str = None, top_k: int = 5):
    """执行查询"""
    # 解析意图类型
    intent = None
    if intent_type:
...
def main():
    parser = argparse.ArgumentParser(
        description="SE-KB 知识库语义检索工具", formatter_class=argparse.RawDescriptionHelpFormatter
    )
