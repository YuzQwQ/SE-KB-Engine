...
def main():
    parser = argparse.ArgumentParser(
        description="SE-KB 向量索引构建工具", formatter_class=argparse.RawDescriptionHelpFormatter
    )

    parser.add_argument("--reset", "-r", action="store_true", help="重置并重建所有索引")
    parser.add_argument("--stats", "-s", action="store_true", help="仅显示当前索引统计")
